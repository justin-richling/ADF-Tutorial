...
# Running the ADF against CMIP simulations requires a bit different configuration of the run-time config file. 
# 
# Let's again copy the the config yaml file we made in <a href = "">CAM vs CAM</a> section
